...
const TOOLTIP_STYLE = { background: 'var(--bg-panel)', border: '1px solid var(--border)', fontSize: 10, borderRadius: 0, color: 'var(--text-primary)' }
            ...
            <div className="panel">
              ...
              <ResponsiveContainer width="100%" height={200}>
                <LineChart data={signalVolumeData} margin={{ top: 6, right: 12, bottom: 6, left: -20 }}>
                  ...
                  <Tooltip contentStyle={TOOLTIP_STYLE} labelStyle={{ color: 'var(--accent)' }} cursor={{ stroke: 'rgba(0,212,180,0.2)' }} />
            ...
            <div className="panel">
              ...
              <ResponsiveContainer width="100%" height={200}>
                <PieChart>
                  ...
                  <Tooltip contentStyle={TOOLTIP_STYLE} labelStyle={{ color: 'var(--accent)' }} />
                </PieChart>
              </ResponsiveContainer>
            </div>
          </div>
          ...
          <div className="panel">
            ...
            <ResponsiveContainer width="100%" height={200}>
              <BarChart data={starData} margin={{ top: 0, right: 0, bottom: 20, left: -20 }}>
                ...
                <YAxis tick={MONO_TICK} stroke="#1f2d45" />
                <Tooltip contentStyle={TOOLTIP_STYLE} labelStyle={{ color: 'var(--accent)' }} cursor={{ fill: 'rgba(0,212,180,0.05)' }} />
